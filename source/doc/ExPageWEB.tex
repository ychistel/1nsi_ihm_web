...
\begin{NSI}
{Exercice}{Langage HTML et CSS}
\end{NSI}


\subsection*{\Large Exercice}
L'objectif de l'exercice est de créer 2 pages web, \textsf{page1.html}  et \textsf{page2.html}, contenant des photos. On pourra passer de la page 1 à la page 2 à l'aide de liens hypertexte.

Les photos seront téléchargées dans un dossier \textsf{img} et devront illustrer un thème à choisir (jeux, motos, animaux,..).

Une feuille de style \textsf{style.css} sera aussi créée dans un dossier \textsf{css}.

\begin{enumerate}
\item Créer le dossier \textsf{public\_html} qui contient les fichiers et dossiers comme le montre la figure suivante.

\begin{center}
\includegraphics[scale=0.8]{../img/public_html.eps}
\end{center}

\item Ajouter dans le dossier image 4 photos dont la largeur et la hauteur seront comprises entre 300px et 400px.

\item Créez votre fichier page1.html en insérant :
\begin{itemize}
\item Un titre de niveau 1 en rapport avec le thème choisi.
\item Un paragraphe de description de votre thème (environ 3 lignes)
\item Une des quatre images téléchargées.
\item En bas de page, un lien vers page2.html
\end{itemize}
\item Créez votre fichier page2.html en insérant :
\begin{itemize}
\item Le titre de niveau 1en rapport avec le thème choisi.
\item Les trois autres images.
\item En bas de page, un lien vers page1.html
\end{itemize}
\item Vérifiez sur votre navigateur que les contenus sont bien affichés et que vous pouvez passer d'une page à l'autre.
\item Ajouter dans la feuille de style des propriétés css pour:
\begin{enumerate}
\item Centrer le titre de niveau \textsf{h1}
\item Mettre en couleur le titre de la page.
\item Avoir une classe \textsf{cadre} pour encadrer les images.
\item Centrer sur la page le lien hypertexte vers l'autre page.
\end{enumerate}
\end{enumerate}
